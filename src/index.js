...
//     exec(
//       `tippecanoe-decode /root/repos/fans_club/mbTiles/1.mbtiles ${z} ${x} ${y}`,
//       { maxBuffer: 1025 * 10000 },
//       async (error, stdout, stderr) => {
//         if (error) console.log(error);
//         const obj = await JSON.parse(stdout);
//         console.log(obj.features[1].features.length);
//         obj.features[1].features.forEach(async (el, i) => {
//           // console.log(el);
//           const query = {
//             name1: el.properties.NAME_0,
//             name2: el.properties.NAME_1,
//             name3: el.properties.NAME_2,
//           };
//           console.log(query);
//           // if (el.NAME_1) query.name0 = el.NAME_0;
//           const res = await Geo.findOne(query).exec();
//           // console.log(res);
//           console.log(res.fid, el.id);
//           if (res.fid !== el.id) console.log("-----------------");

//           if (i === obj.features[1].features.length - 1) {
//             // console.log("done");
//             resolve();
//           }
//         });
